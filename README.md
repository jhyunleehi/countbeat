...
`${GOPATH}/src/github.com/jhyunleehi/countbeat`
...
```
git remote set-url origin https://github.com/jhyunleehi/countbeat
...
```
mkdir -p ${GOPATH}/src/github.com/jhyunleehi/countbeat
git clone https://github.com/jhyunleehi/countbeat ${GOPATH}/src/github.com/jhyunleehi/countbeat
```
